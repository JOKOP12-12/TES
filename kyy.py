...
# LAYER 7 METHODS
            ...
            try:
                target = cnc.split()[1]
                time = cnc.split()[2]
                os.system(f'go run hentai.go {Target} {time}')
            except IndexError:
...
#TOOLS
            ...
            print(f'''
\x1b[38;2;0;212;14mlayer7► SHOW LAYER7 METHODS
\x1b[38;2;0;212;14mlayer4► SHOW LAYER4 METHODS
\x1b[38;2;0;212;14mrules► RULES PANEL
\x1b[38;2;0;212;14mTOOLS   ► SHOW TOOLS
